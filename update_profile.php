...
if(isset($_POST['submit'])){
   ...
   if(!empty($email)){
      ...
      if($select_email->rowCount() > 0){ //عشان يتأكد الايميل الي بدي احدثه مو موجود ب database
   ...
   $empty_pass = 'da39a3ee5e6b4b0d3255bfef95601890afd80709'; //like input to  enter the password in login and register
